          ...
          <div>
            <div className="flex items-center lg:justify-start justify-center gap-1">
              ...
              <p className="text-slate-100 text-2xl">
                IntelliForm<span className="text-sm text-primary">ai</span>
              </p>
            </div>

            <ul className="flex justify-center gap-6 mt-5 md:gap-8 lg:justify-start">
              <li>
                <a
                  href="/"
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="relative flex w-2 h-2 -mr-2">
                        <span className="absolute inline-flex w-full h-full bg-blue-700 rounded-full opacity-75 animate-ping"></span>
